...
classes_search_operation_description = "기능\n" \
                                       ...
                                       "- 200: 수업 검색 성공\n" \
                                       "\n사용 예시\n" \
                                       "- '영' 키워드가 들어간 수업 중 3번째 목록을 불러오고 싶다면, " \
                                       "\"baseURL/etl/classes/search/?class_name=영&page=3\" GET 요청."
    ...
    200: openapi.Schema(
        ...
        properties={
            'count': openapi.Schema(
                ...
                description='해당 검색 조건을 만족하는 수업의 총 갯수입니다.',
            ),
            'next': openapi.Schema(
...
classes_search_parameter_page = openapi.Parameter(
    'page',
    openapi.IN_QUERY,
...
classes_search_manual_parameters = [
    classes_search_parameter_class_name,
    classes_search_parameter_page,
]
