...
announcement_get_operation_description = '기능\n' \
                                         ...
                                         '- 403: 잘못된 접근(ex: 공지사항 게시판에서 질의응답 글 불러오기)\n' \
                                         '\n비고\n' \
...
announcement_get_responses = {
    200: openapi.Schema(
        ...
        description='공지 글의 세부 정보 입니다.',
        properties={
            'post_info': openapi.Schema(
                'Post',
                type=openapi.TYPE_OBJECT,
                description='해당 공지글의 정보입니다.',
                properties={
                    'id': openapi.Schema(
            ...
            'next_post': openapi.Schema(
                ...
                properties={
                    ...
                    'title': openapi.Schema(
                        type=openapi.TYPE_STRING,
                        description='다음 공지글 제목 입니다.',
                    ),
                    'created_by': openapi.Schema(
                        'User',
                        type=openapi.TYPE_OBJECT,
                        description='다음 공지 글을 생성한 사람의 정보 입니다.',
                        properties={
                            'id': openapi.Schema(
                                type=openapi.TYPE_INTEGER,
                                read_only=True,
            ...
            'prev_post': openapi.Schema(
                ...
                properties={
                    ...
                    'title': openapi.Schema(
                        type=openapi.TYPE_STRING,
                        description='이전 공지글 제목 입니다.',
                    ),
                    'created_by': openapi.Schema(
                        'User',
                        type=openapi.TYPE_OBJECT,
                        description='이전 공지 글을 생성한 사람의 정보 입니다.',
                        properties={
                            'id': openapi.Schema(
                                type=openapi.TYPE_INTEGER,
                                read_only=True,
